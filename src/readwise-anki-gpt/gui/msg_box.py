...
def delete_all_data_confirmation():
    ...
    input_dialog.setWindowIcon(input_dialog.style().standardIcon(QStyle.StandardPixmap.SP_MessageBoxWarning))
    ...
    while True:
        ...
        if ok and input == confirmation_text:
            ...
            QMessageBox.warning(None, "Incorrect Input", f"Your input was incorrect.<br><br>Please type '{confirmation_text}' to confirm.")
